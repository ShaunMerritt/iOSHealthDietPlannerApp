//
//  SMSecondEditPatientTableViewController.m
//  Elu
//
...
@interface SMSecondEditPatientTableViewController ()

@end

@implementation SMSecondEditPatientTableViewController
...
-(void)popover:(id)sender
{
    ...
    SMSecondEditPatientTableViewController *controller = [[SMSecondEditPatientTableViewController alloc] initWithStyle:UITableViewStylePlain];
