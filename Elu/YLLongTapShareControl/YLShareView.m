...
- (void)dismissShareView {
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        SMNutritionViewController *vc = [[SMNutritionViewController alloc] init];
...
- (void)doneSelected {
    ...
    _selectTimer = nil;
//    
//    if ([_selectedView.shareTitle  isEqual: @"Facebook"]) {
//        NSLog(@"YESSSS");
//        
//        //            if (self.myEventCallBack) {
//        //                self.myEventCallBack(_selectedView.shareTitle);
//        //            }
//        
//        UIResponder* r = self; // the view instance, living in the interface
//        while (![r isKindOfClass:[SMNutritionViewController class]])
//            r = [r nextResponder];
//        
//        SMNutritionViewController* vc = (SMNutritionViewController*)r;
//        
//        [vc testMethod];
//        
//        //SMNutritionViewController *controller = [[SMNutritionViewController alloc] init];
//        
//        //[controller testMethod];
//        
//        //[controller performSelector:@selector(yourNewFunction) withObject:nil afterDelay:1.0];
//    }
